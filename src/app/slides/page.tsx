...
const SLIDES: SlideData[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Chat widget, transaction tracking, provider fee breakdown",
      "Zero crypto experience → deployed production app",
    ],
    visual: "screenshot",
  },
  {
    ...
    subtitle: "Switch to browser now",
    bullets: [
      "1. Enter $200 → auto-validates against purchase limits",
      "2. Get Quotes → providers ranked by rampScore",
      "3. Compare fees: total, network, provider, partner",
      "4. Swap arrow → flip to Sell mode (crypto → fiat)",
      "5. Settings → 228 countries, 50 currencies, 10 payment methods",
      "6. Token selector → sandbox badges, search",
    ],
  ...
  },
  {
    ...
    columns: [
      ...
      { heading: "Backend", items: ["8 API routes (proxy layer)", "API key never in browser", "7-day TTL cache for static data", "Retry on 5xx errors"] },
